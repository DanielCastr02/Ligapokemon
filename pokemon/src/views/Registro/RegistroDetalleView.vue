        ...
        <div class="card">
            ...
            <div class="card-body row" >
                ...
                <Form  class="col-md-6">
                    <div class="mb-3">
                        idTrainer
                        <Field name="idtrainer" id="idtrainer" type="text" class="form-control" :disabled="true"  v-model="model.registro.idtrainer"/>
                        <ErrorMessage name="idtrainer" class="errorValidacion"/>
                    </div>
                ...
                <Form  class="col-md-6">
                    <div class="mb-3">
                            idPokemon
                            <Field name="idpokemon" id="idpokemon" type="text" class="form-control" :disabled="true"  v-model="model.registro.idpokemon"/>
                            <ErrorMessage name="idpokemon" class="errorValidacion"/>
                        </div>
                         <div class="form-group">
        ...
        methods:{
            getRegistro(id) {
                apiclient.registros.getRegistroDetalle(id).then(res => {
                    ...
                    // this.model.registro.pokemon_sexo = registroData.pokemon_sexo;
                });
            }
        }
}
